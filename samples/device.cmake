...
set(LINKER_SCRIPT_MASTER ${BASE_LOCATION}/device/${CPU_FAMILY_U}/Source/GCC/${CPU_FAMILY_L}.ld)
...
set(STARTUP_FILE ${BASE_LOCATION}/device/${CPU_FAMILY_U}/Source/GCC/startup_${CPU_FAMILY_L}.S)

# Set system file name
# set(SYSTEM_FILE ${BASE_LOCATION}/device/${CPU_FAMILY_U}/Source/system_${CPU_FAMILY_L}.c)
